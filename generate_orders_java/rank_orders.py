...
def create_test_order_mapping(samplefile):
    with open(samplefile, "r") as f:
        ...
        test_order_mapping = {test_order: index for index, test_order in enumerate(test_orders)}
...
if __name__ == "__main__":
    ...
    for i in range(rounds):
        ...
        with open(next_round, "r") as f:
            data = json.load(f)
            test_orders = data['testOrder']
            new_indices = [test_order_mapping[test_order] for test_order in test_orders]
